...
description: "트래픽, 키워드, SEO 분석, 성과 기반 인사이트. 트리거: '트래픽 확인', '키워드 분석', '성과 확인', 'SEO 분석', '성과 좋은 글', 'analytics', '유입 분석'"
---
...
`$ARGUMENTS`가 제공된 경우 (예: `/check-analytics 키워드`), 해당 분석 유형으로 바로 진행합니다.
- "키워드", "keyword" → 키워드 분석 워크플로우
- "트래픽", "traffic" → 전체 트래픽 워크플로우
- "포스트 123", "post 123" → 특정 포스트 분석
- 기타 → 유저에게 원하는 분석 유형 확인
